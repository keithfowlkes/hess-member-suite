-- Fix DELETE without WHERE clause in refresh_analytics_datacube_sql
...
DECLARE
  ...
  total_fte INTEGER;
BEGIN
  -- Use explicit WHERE clause instead of DELETE without WHERE
  DELETE FROM system_analytics_datacube WHERE true;
  ...
  DELETE FROM system_analytics_datacube WHERE institution_count = 0 AND true;
END;
$function$;