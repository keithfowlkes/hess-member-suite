-- Copy software systems data from profiles to organizations where it's missing
...
WHERE public.organizations.contact_person_id = p.id 
  AND (
    public.organizations.student_information_system IS NULL 
    OR public.organizations.financial_system IS NULL
  );