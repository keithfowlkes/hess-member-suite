-- Temporarily drop the problematic functions to avoid conflicts
DROP FUNCTION IF EXISTS public.check_and_fix_missing_organizations() CASCADE;
DROP FUNCTION IF EXISTS public.fix_missing_organizations() CASCADE;
