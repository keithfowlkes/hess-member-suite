      ...
      try {
        ...
        if (orgError) {
          ...
          const organizationData = {
            ...
            payment_platform: orgData.payment_platform || '',
            meal_plan_management: orgData.meal_plan_management || '',
            identity_management: orgData.identity_management || '',
            door_access: orgData.door_access || '',
            document_management: orgData.document_management || '',
            voip: orgData.voip || '',
            network_infrastructure: orgData.network_infrastructure || '',
