...
import { ArcticPricingRequestModal } from '@/components/ArcticPricingRequestModal';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <CardContent className="space-y-4 text-sm text-muted-foreground">
          <p className="whitespace-pre-wrap">
            ...
            Arctic Security is an early warning service and this display is only counts for security events that they see for you.  Their full service gives you full detail information on these threats, vulnerabilities, and sources. <span className="underline">Arctic Security does not remediate security issues for your campus.</span> If you need these services, DeepSeas Security is our HESS recommended partner.
          </p>
