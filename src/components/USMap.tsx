...
// US State coordinates spread out by additional 5% from center (450, 250)
const stateCoordinates: { [key: string]: { x: number; y: number } } = {
  'AL': { x: 633, y: 329 },
  'AK': { x: 51, y: 423 }, // Alaska positioned bottom-left
  'AZ': { x: 208, y: 288 },
  'AR': { x: 550, y: 296 },
  'CA': { x: 82, y: 199 },
  'CO': { x: 340, y: 249 },
  ...
  'FL': { x: 734, y: 407 },
  'GA': { x: 686, y: 313 },
  'HI': { x: 177, y: 407 }, // Hawaii positioned in Pacific
  'ID': { x: 233, y: 119 },
  'IL': { x: 597, y: 198 },
  'IN': { x: 624, y: 186 },
  'IA': { x: 550, y: 157 },
